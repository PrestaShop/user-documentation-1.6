...
* [Installing PrestaShop in 10 minutes](installing-prestashop.md#InstallingPrestaShop-InstallingPrestaShopin10minutes)
...
## Installing PrestaShop in 10 minutes <a href="#installingprestashop-installingprestashopin10minutes" id="installingprestashop-installingprestashopin10minutes"></a>
...
Before you get started, make sure you have all the requirements available: server space at a hosting provider, domain name, FTP client, text editor. Makes sure to follow the instructions in the "[What you need to get started](what-you-need-to-get-started.md).

Our official web hosting partner 1&1 offer a 1-click install in order to save you time and get you started even faster. Using these can drastically reduce the installation time for inexperienced users.&#x20;
...
### Quick installation instructions <a href="#installingprestashop-quickinstallationinstructions" id="installingprestashop-quickinstallationinstructions"></a>
...
PrestaShop should now be installed and ready to be configured! Continue to the [First steps with PrestaShop 1.6](../user-guide/first-steps-with-prestashop-1.6.md) chapter of the User Guide.

### Detailed instructions <a href="#installingprestashop-detailedinstructions" id="installingprestashop-detailedinstructions"></a>

#### Downloading and unzipping the PrestaShop archive <a href="#installingprestashop-downloadingandunzippingtheprestashoparchive" id="installingprestashop-downloadingandunzippingtheprestashoparchive"></a>
...
![](../../.gitbook/assets/39125009.png)

You only have one download option: the latest stable version, ready for all kinds of online stores.

If you need to download any of the previous versions, go to this address: [http://www.prestashop.com/en/developers-versions](http://www.prestashop.com/en/developers-versions). Scroll down to the "Previously released versions" section.

Note that it is never recommended to use any other version than the current stable one.

Click on the "Download" button, and save the archive on your computer (such as on your Desktop). You should get a file named "prestashop\_1.6.0.4.zip" (or an equivalent, depending on the version numbers).
...
* The "prestashop" folder, which contains all the PrestaShop files that you will soon be uploading on your web server.
...
#### Uploading PrestaShop <a href="#installingprestashop-uploadingprestashop" id="installingprestashop-uploadingprestashop"></a>
...
#### Creating a database for your shop <a href="#installingprestashop-creatingadatabaseforyourshop" id="installingprestashop-creatingadatabaseforyourshop"></a>
...
#### Launching the auto-installer <a href="#installingprestashop-launchingtheauto-installer" id="installingprestashop-launchingtheauto-installer"></a>
...
You can also directly type the address of the `/install` folder: [`http://www.example.com/prestashop_folder/install`](http://www.example.com/prestashop\_folder/install).
...
![](../../.gitbook/assets/39125006.png)

You also get a link to the documentation site ([http://doc.prestashop.com/](http://doc.prestashop.com/)), and the PrestaShop support phone number. You can learn more about our support service by going to [http://support.prestashop.com/en/](http://support.prestashop.com/en/).
...
#### Completing the installation <a href="#installingprestashop-completingtheinstallation" id="installingprestashop-completingtheinstallation"></a>
